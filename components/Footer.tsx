    ...
    <footer className="bg-industrial-950 text-white pt-16 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
          <div>
            <div className="mb-6">
              <h3 className="font-bold text-white text-xl">Green Electric</h3>
              <p className="text-green-electric-400 text-sm mt-1">Lightning & Grounding Solutions</p>
            </div>
            <p className="text-industrial-400 leading-relaxed text-sm">
              Your one-stop partner for advanced lightning protection, precision grounding systems, and industrial materials since 1993. From interception to grounding — complete safety systems with perfect compatibility.
            </p>
            <div className="mt-6 flex items-center gap-3">
              ...
              <div className="text-sm">
                <div className="text-white font-medium">One-Stop Solutions</div>
                <div className="text-industrial-500">Design · Supply · Support</div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-industrial-400">
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-3 mt-0.5 text-green-electric-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
        ...
        <div className="border-t border-industrial-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-industrial-500 text-sm">
              © 2026 Green Electric Industrial Supply. All rights reserved.
            </p>
            <div className="flex items-center gap-6 text-industrial-500 text-sm">
              <span>Specializing in Lightning Protection & Grounding Solutions</span>
            </div>
          </div>
        </div>
      </div>
