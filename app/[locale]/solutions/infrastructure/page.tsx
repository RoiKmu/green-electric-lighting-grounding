...
const solutionContent = {
  hero: {
    ...
    descriptionAr: 'لا ينبغي أن يأتي تصميم حماية الصواعق للمباني الأيقونة على حساب المظهر. ندعو إلى نظام اعتراض متكامل مع هيكل المبنى.',
  },
  challenges: {
    title: '挑战与行业痛点',
    ...
    descriptionAr: 'الملاعب والمحطات والمباني المماثلة لها متطلبات عالية جدًا للمظهر وسهولة الصيانة.',
    items: [
      {
        title: '建筑美学要求',
        titleEn: 'Architectural Aesthetics Requirements',
        titleAr: 'متطلبات الجمال المعماري',
        ...
        descriptionAr: 'المباني العامة الأيقونة لها متطلبات عالية جدًا للمظهر.',
      },
      {
        title: '维护便捷性',
        titleEn: 'Maintenance Convenience',
        titleAr: 'سهولة الصيانة',
        ...
        descriptionAr: 'المباني العامة الكبيرة لها هياكل معقدة.',
      },
      {
        title: '公共安全责任',
        titleEn: 'Public Safety Responsibility',
        titleAr: 'مسؤولية السلامة العامة',
        ...
        descriptionAr: 'بالنسبة للأماكن المكتظة بالأشخاص مثل الملاعب والمحطات.',
      },
      {
        title: '建筑高度高结构复杂',
        titleEn: 'Tall & Complex Structures',
        titleAr: 'هياكل عالية ومعقدة',
        ...
        descriptionAr: 'المباني الأيقونة عالية ذات هياكل معقدة.',
      },
      {
        title: '侧击雷防护要求',
        titleEn: 'Side-Strike Protection Requirements',
        titleAr: 'متطلبات حماية الصواعق الجانبية',
        ...
        descriptionAr: 'المباني شاهقة الطول لها متطلبات عالية جدًا لحماية الصواعق الجانبية.',
      },
      {
        title: '接闪器隐蔽性',
        titleEn: 'Concealed Air Terminals',
        titleAr: 'محطات هوائية مخفية',
        ...
        descriptionAr: 'الجماليات المعمارية تتطلب محطات هوائية مخفية.',
      },
    ],
  },
  solutions: {
    ...
    descriptionAr: 'الارتقاء من الدفاع السلبي التقليدي إلى الإنذار المبكر النشط.',
    items: [
      {
        title: '建筑结构一体化',
        titleEn: 'Building Structure Integration',
        titleAr: 'التكامل مع هيكل المبنى',
        ...
        descriptionAr: 'ندعو إلى نظام اعتراض متكامل مع هيكل المبنى.',
      },
      {
        title: '智慧雷击监测',
        titleEn: 'Intelligent Lightning Monitoring',
        titleAr: 'مراقبة الصواعق الذكية',
        ...
        descriptionAr: 'من خلال نشر مستشعرات مراقبة الصواعق الذكية.',
      },
      {
        title: '可视化运维数据',
        titleEn: 'Visualized Operation Data',
        titleAr: 'بيانات التشغيل المرئية',
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
            {t(
              ...
              'اتصل بنا للحصول على حلول حماية من الصواعق متكاملة جماليًا'
            )}
          </p>
