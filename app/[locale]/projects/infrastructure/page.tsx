...
const projects = [
  ...
  {
    id: 'algeria-great-mosque',
    title: '阿尔及利亚嘉玛大清真寺',
    titleEn: 'Algeria Great Mosque of Algiers',
    titleAr: 'جامع الجزائر الكبير',
    location: '阿尔及利亚',
    locationEn: 'Algeria',
    locationAr: 'الجزائر',
    year: '2019',
    background: '非洲最大清真寺，中国建筑 (CSCEC) 承建。',
    backgroundEn: 'Largest mosque in Africa, constructed by CSCEC.',
    backgroundAr: 'أكبر مسجد في أفريقيا، من تنفيذ CSCEC.',
    highlight: '为宗教建筑提供专用防雷保护方案，确保建筑群安全。',
    ...
    challengesEn: [
      'Special protection requirements for religious architecture',
      'Lightning protection coordination for large complex',
      'Climate adaptability for North Africa region',
    ],
    challengesAr: [
      'متطلبات حماية خاصة للعمارة الدينية',
      'تنسيق حماية الصواعق للمجمع الكبير',
      'التكيف المناخي لمنطقة شمال أفريقيا',
    ],
    solutions: [
      '宗教建筑专用防雷方案',
      '大型建筑群综合防护',
    ...
    solutionsEn: [
      'Specialized lightning protection for religious architecture',
      'Integrated protection for large complex',
      'North Africa climate adaptive design',
    ],
    solutionsAr: [
      'حماية صواعق متخصصة للعمارة الدينية',
      'حماية متكاملة للمجمع الكبير',
      'تصميم متكيف مع مناخ شمال أفريقيا',
    ],
    image: '/images/projects/Infrastructure/Algeria-mosque-eyecatcher-valbeveiliging.jpg',
  },
];
