...
const projects = [
  ...
  },
  {
    ...
    locationAr: 'الإمارات',
    year: '2023',
    background: '连接阿联酋全境的大型铁路网，由中国铁建/中交 (CRCC/CCCC) 参与。',
    backgroundEn: 'Large-scale railway network connecting all of UAE, with participation from CRCC/CCCC.',
    backgroundAr: 'شبكة سكك حديدية واسعة النطاق تربط جميع أنحاء الإمارات، بمشاركة CRCC/CCCC.',
    ...
    challengesAr: [
      'تأريض متكيف مع بيئة الصحراء',
      'حماية جميع محطات القاعدة للاتصالات',
      'حماية المنشآت الحرجة لمراكز التحكم',
    ],
    solutions: [
      '自适应沙漠环境接地系统',
      '通信基站综合防护',
    ...
    solutionsAr: [
      'نظام تأريض متكيف مع بيئة الصحراء',
      'حماية متكاملة لمحطات القاعدة للاتصالات',
      'حماية المنشآت الحرجة لمراكز التحكم',
    ],
